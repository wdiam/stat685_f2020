...
```{r fitElasticNet, cache = TRUE, dependson = 'data_setup', fig.cap="Cross-Validation Risk Estimates for Elastic Net Hyper Parameters"}
set.seed(1)
...
\subsubsection{Example}
```{r fitMARS, cache = TRUE, dependson = 'data_setup', fig.cap="Cross-Validation Risk Estimates for MARS"}
set.seed(1)
...
```{r fitMARS_vip, cache = TRUE, dependson = 'fitMARS', echo=FALSE, fig.cap="Variable Importance per MARS"}
